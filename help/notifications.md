---
title: Notifications and watching cards
summary: Which card events notify you, how watching works, and how to turn any of it off
tags: [notifications, watching, assigned, due dates, reminders]
order: 40
---
...
Watching a card means hearing about what happens to it. You watch a card
automatically when you create it, are set as its reporter, are assigned to it,
or comment on it. To follow any other card, open it and click the bell at the
top of the panel; the number beside the bell is how many people are watching.

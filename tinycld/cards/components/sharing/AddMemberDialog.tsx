 ...
 * contact email; cards has no such endpoint and a cards member is always an
...
export function AddMemberDialog({
    ...
    const [role, setRole] = useState<CardsMemberRole>('viewer')
...
function RolePicker({
    ...
    onChange: (role: CardsMemberRole) => void
}) {
    return (

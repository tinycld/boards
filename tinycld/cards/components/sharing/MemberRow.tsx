...
interface MemberRowProps {
    ...
    onRoleChange: (membershipId: string, role: CardsMemberRole) => void
 ...
 * MemberRow, with cards' NameAvatar and a "Leave" action on the caller's own
...
export function MemberRow({ member, actions, onRoleChange, onRemove, onLeave }: MemberRowProps) {
    ...
    return (
        <View
            testID={`cards-member-row-${member.userId}`}

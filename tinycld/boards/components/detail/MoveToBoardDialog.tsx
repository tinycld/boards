...
import type { BoardCardView, BoardProject, BoardsProjects } from '../../types'
        ...
        <View>
            ...
            {boards.map(board => (
                <ChoiceRow
                    ...
                    testID={`boards-move-board-${board.id}`}
            ...
            {count > 0 ? (
                <>
                    <ChoiceRow
                        ...
                        testID="boards-move-family-move"
                    ...
                    <ChoiceRow
                        ...
                        testID="boards-move-family-unlink"

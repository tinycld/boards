 ...
 *
 * `?focused=` rather than the full-page `/a/boards/<key>` route: a link shared with
...
export function focusedCardURL(cardKey: string): string {
    const path = `${appHref('boards')}?focused=${encodeURIComponent(cardKey)}`

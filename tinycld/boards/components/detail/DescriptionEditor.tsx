...
interface DescriptionEditorProps {
     ...
     */
    description?: string
    /** The read view itself. Boards' own component: core never renders content. */
    readView: ReactNode
}
 ...
 * back to `boards_cards.description`, so the ideas of "revert" and "save" have
    ...
    const slots = useLazyEditor({
        ...
        editorOptions: {
            ...
            collab: !doc
                ...
                : {
                      document: doc,
                      // Must match cardFragment() in boards/server/bootstrap.go.
                      field: `card:${cardId}`,
        ...
        testID: 'boards-description-read',
...
function DescriptionBody({
    ...
    return (
        ...
        <View ref={containerRef} className="overflow-visible">
            ...
            <View
                testID="boards-description-editor"
                className="pt-2"

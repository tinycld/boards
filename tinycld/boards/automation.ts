...
import type { BoardsSchema } from './types'

// Every trigger here resolves owners through one boards_project_members
// resolver (server/automation.go). boards_cards has created_by, which the
...
const automation = {
    triggers: [
        ...
        },
        {
            ...
            // couldn't express it anyway: the category lives on boards_lists,
            ...
            params: [
                {
                    key: 'label',
                    type: 'relation',
                    relationTarget: 'boards_labels',
                    label: 'Label',
                },
            ],
        },
    ],
} satisfies AutomationDefinitions<BoardsSchema>

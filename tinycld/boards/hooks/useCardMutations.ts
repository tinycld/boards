 ...
 * denormalized relation is what every boards_cards access rule resolves
...
export function useCreateCard(projectId: string) {
    ...
    return useMutation<string, Error, CreateCardInput>({
        mutationKey: ['boards', 'card', 'create'],
...
export function useDuplicateCard(projectId: string) {
    const { user } = useAuth({ throwIfAnon: false })
    const [cardsCollection, itemsCollection] = useStore('boards_cards', 'boards_checklist_items')

    return useMutation<string, Error, DuplicateCardInput>({
        mutationKey: ['boards', 'card', 'duplicate'],
...
export function useUpdateCard() {
    ...
    return useMutation<void, Error, UpdateCardInput>({
        mutationKey: ['boards', 'card', 'update'],
...
export function useArchiveCard() {
    ...
    return useMutation<void, Error, { cardId: string; archived: boolean }>({
        mutationKey: ['boards', 'card', 'archive'],
...
export function useDeleteCard() {
    ...
    return useMutation<void, Error, string>({
        mutationKey: ['boards', 'card', 'delete'],
...
export function useToggleCardRelation() {
    ...
    >({
        mutationKey: ['boards', 'card', 'toggle-relation'],
